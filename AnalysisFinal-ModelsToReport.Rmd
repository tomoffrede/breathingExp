...
ggplot(dat, aes(act, cycleDur))+
  ...
  ggtitle("Listen vs Watch - Cycle Duration")
ggsave(paste0(folderInd, "ListenWatch-CycleDur.png"), width = 3000, height=3000, units="px")

ggplot(dat %>% filter(act == "listening"), aes(Condition, cycleDur))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Listen - Cycle Duration")
ggsave(paste0(folderInd, "Listen-CycleDur.png"), width = 3000, height=3000, units="px")

ggplot(dat %>% filter(act == "watching"), aes(Condition, cycleDur))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Watch - Cycle Duration")
ggsave(paste0(folderInd, "Watch-CycleDur.png"), width = 3000, height=3000, units="px")
```
...
ggplot(dat, aes(act, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Listen vs Watch - Inhalation Amplitude")
ggsave(paste0(folderInd, "ListenWatch-InhalAmp.png"), width = 3000, height=3000, units="px")

ggplot(dat %>% filter(act == "listening"), aes(Condition, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Listen - Inhalation Amplitude")
ggsave(paste0(folderInd, "Listen-InhalAmp.png"), width = 3000, height=3000, units="px")

ggplot(dat %>% filter(act == "watching"), aes(Condition, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Watch - Inhalation Amplitude")
ggsave(paste0(folderInd, "Watch-InhalAmp.png"), width = 3000, height=3000, units="px")
```
```{r}
...
# Breathing data during SYNCHRONOUS READ speech
...
ggplot(dat, aes(Cond2, cycleDur))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Synchronous Speech - Cycle Duration")
ggsave(paste0(folderInd, "Sync-CycleDur.png"), width = 3000, height=3000, units="px")
```
...
ggplot(dat, aes(Cond2, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Synchronous Speech - Inhalation amplitude")
ggsave(paste0(folderInd, "Sync-InhalAmp.png"), width = 3000, height=3000, units="px")
```
...
Inhalation amplitude increases with physical effort.
...
# Speech data: SYNCHRONOUS READ speech
...
ggplot(df, aes(Condition, f0raw))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Synchronous Speech - f0")
ggsave(paste0(folderInd, "Sync-f0.png"), width = 3000, height=3000, units="px")
```
...
ggplot(df, aes(Cond2, articRateIPU))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Synchronous Speech - Articulation rate")
ggsave(paste0(folderInd, "Sync-ArticRate.png"), width = 3000, height=3000, units="px")
```
...
No effect on articulation rate.

```{r}
df$Condition <- relevel(df$Condition, ref="Sitting")
summary(s1 <- lmer(articRateIPU ~ Condition + (1 +Condition | Speaker), df))

summary(s2 <- lmer(articRateIPU ~ Cond2 + (1 +Cond2 | Speaker), df))
...
# Breathing data during SOLO READ speech
...
ggplot(dat, aes(Condition, cycleDur))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Lone read Speech - Cycle duration")
ggsave(paste0(folderInd, "LoneRead-CycleDur.png"), width = 3000, height=3000, units="px")
```
...
Inhalation duration doesn't change across conditions (nor Cond2 or Cond3).
...
ggplot(dat, aes(Cond2, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Lone read Speech - Inhalation amplitude")
ggsave(paste0(folderInd, "LoneRead-InhalAmp.png"), width = 3000, height=3000, units="px")
```
...
Inhalation amplitude did not change across conditions either (nor Cond2 or Cond3).
...
summary(a1 <- lmer(inhalAmp ~ Condition + (1 + Condition | Speaker), dat))
summary(a2 <- lmer(inhalAmp ~ Cond2 + (1 + Cond2 | Speaker), dat))
summary(a3 <- lmer(inhalAmp ~ Cond3 + (1 + Cond3 | Speaker), dat))
...
ggplot(df, aes(Condition, f0raw))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Lone read Speech - f0")
ggsave(paste0(folderInd, "LoneRead-f0.png"), width = 3000, height=3000, units="px")
```
...
ggplot(df, aes(Cond2, f0raw))+
  geom_boxplot()
```

The only f0 difference is between Baseline and Light (so I think this is noise?). Interaction vs. Alone is almost significant but not quite.


```{r}
df$Condition <- relevel(df$Condition, ref="Light")
summary(f1 <- lmer(f0raw ~ Condition + (1 + Condition | Speaker), df))
summary(f1a <- lmer(f0raw ~ Cond2 + (1 + Cond2 | Speaker), df))
...
ggplot(df, aes(Cond2, articRateIPU))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Lone read Speech - Articulation rate")
ggsave(paste0(folderInd, "LoneRead-ArticRate.png"), width = 3000, height=3000, units="px")
```
...
Articulation rate didn't change across conditions.
...
# Breathing data: SOLO vs SYNCHRONOUS READ SPEECH
...
```{r, include=FALSE}
dat <- brm %>%
  filter(Role=="Participant", Task%in%c("ReadAlone", "ReadJoint")) %>%
  filter(!duplicated(file)) %>% 
  mutate(breathCycle = gsub("cycle", "", breathCycle)) %>%
  mutate_at(c("Speaker", "act", "Condition", "Task", "Role"), as.factor) %>%
  mutate_at(c("numberIPUs", "numberBreathCycles", "breathCycle"), as.integer) %>%
...
```{r}
ggplot(dat, aes(Task, breathRate))+
  geom_boxplot()
...
ggplot(dat, aes(Cond3, breathRate))+
  geom_boxplot()+
  facet_wrap(~Task)+
  scale_x_discrete(limits = orderCond3)
```

* Breathing rate doesn't change across Tasks (nor in interaction with condition).

```{r}
summary(b1 <- lmer(breathRate ~ Task + (1 | Speaker), dat))
summary(b1a <- lmer(breathRate ~ Task:Cond3 + (1 | Speaker), dat))
...
summary(b1a <- lmer(cycleDur ~ Task:Condition + (1 +Task| Speaker), dat))
summary(b1b <- lmer(cycleDur ~ Task:Cond3 + (1 +Task| Speaker), dat))
...
dat <- brm %>%
  ...
  mutate(logInhalDur = log(inhalDur),
         numberIPUsC = numberIPUs - mean(numberIPUs, na.rm=TRUE),
         Cond3 = ifelse(Condition%in%c("Light", "Heavy"), "Biking", ifelse(Condition=="Baseline", "Baseline", "Sitting"))) %>% 
  mutate_at(c("Cond3"), as.factor)
dat$Condition <- relevel(dat$Condition, ref="Sitting")
```

```{r}
ggplot(dat %>% filter(inhalDur < 3), aes(Task, inhalDur))+
  geom_boxplot()
...
Inhalation duration doesn't change across tasks.There are condition effects, which you can see in the separate sections above.

```{r}
dat$Condition <- relevel(dat$Condition, ref="Sitting")
dat$Cond3 <- relevel(dat$Cond3, ref="Sitting")
summary(d5 <- lmer(inhalDur ~ Task + (1+Task | Speaker), dat))
summary(d5a <- lmer(inhalDur ~ Task:Condition + (1+Task | Speaker), dat))
summary(d5b <- lmer(inhalDur ~ Task:Cond3 + (1+Task | Speaker), dat))
...
Inhalation amplitude is lower during Read Joint as compared to Read Alone.

```{r}
dat$Condition <- relevel(dat$Condition, ref="Baseline")
dat$Cond3 <- relevel(dat$Cond3, ref="Sitting")

summary(a1 <- lmer(inhalAmp ~ Task + (1 + Task | Speaker), dat))
summary(a1a <- lmer(inhalAmp ~ Task:Condition + (1 + Task | Speaker), dat))
summary(a1b <- lmer(inhalAmp ~ Task:Cond3 + (1 + Task | Speaker), dat))
...
# Speech data: SOLO vs SYNCHRONOUS READ SPEECH
...
ggplot(df, aes(Cond3, f0raw))+
  geom_boxplot()+
  facet_wrap(~Task)+
  scale_x_discrete(limits = orderCond3)
```

F0 isn't different across tasks (only when we consider the different conditions, since Read Joint has a condition difference and Read Alone doesn't).


```{r}
df$Condition <- relevel(df$Condition, ref="Light")
summary(f1 <- lmer(f0raw ~ Task + (1 + Task | Speaker), df))
summary(f1a <- lmer(f0raw ~ Task:Condition + (1 + Task | Speaker), df))
...
```{r}
ggplot(df, aes(Task, articRateIPU))+
  geom_boxplot()
...
ggplot(df, aes(Cond3, articRateIPU))+
  geom_boxplot()+
  facet_wrap(~Task)+
  scale_x_discrete(limits = orderCond3)
```

Articulation rate didn't change across reading tasks.

```{r}
df$Condition <- relevel(df$Condition, ref="Sitting")
summary(s1 <- lmer(articRateIPU ~ Task + (1+Task | Speaker), df))
summary(s1a <- lmer(articRateIPU ~ Task:Condition + (1+Task | Speaker), df))
summary(s1b <- lmer(articRateIPU ~ Task:Cond3 + (1+Task | Speaker), df))
...
ggplot(dat, aes(Cond2, cycleDur))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Free Speech - Cycle duration")
ggsave(paste0(folderInd, "Free-CycleDur.png"), width = 3000, height=3000, units="px")
```
...
ggplot(dat, aes(Cond2, inhalAmp))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Free Speech - Inhalation amplitude")
ggsave(paste0(folderInd, "Free-InhalAmp.png"), width = 3000, height=3000, units="px")
```
...
No condition effect for inhalation amplitude.


```{r}
summary(a2 <- lmer(inhalAmp ~ Condition + (1 + Condition| Speaker), dat))
summary(a2 <- lmer(inhalAmp ~ Cond2 + (1 + Cond2| Speaker), dat))
...
ggplot(df, aes(Condition, f0raw))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Free Speech - f0")
ggsave(paste0(folderInd, "Free-f0.png"), width = 3000, height=3000, units="px")
```
...
summary(m1 <- lmer(f0raw ~ Cond2 + (1 + Cond2 | Speaker), df))
...
ggplot(df, aes(Cond2, articRateIPU))+
  geom_boxplot()+
  facet_wrap(~Speaker, scales="free_y")+
  ggtitle("Free Speech - Articulation rate")
ggsave(paste0(folderInd, "Free-ArticRate.png"), width = 3000, height=3000, units="px")
```
...
par(mfrow=c(2, 2))
hist(resid(s1a))
qqnorm(resid(s1a));qqline(resid(s1a))
plot(fitted(s1a), resid(s1a))
```

# Breathing across all tasks
...
summary(a1 <- lmer(cycleDur ~ act + (1+act|Speaker), dat))
```
